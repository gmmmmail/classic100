...
//    _defaultColor = [UIColor whiteColor];
    _defaultColor = [UIColor colorWithHue:0 saturation:0 brightness:0 alpha:0.4];
...
//        self.contentView.backgroundColor = isBackgroundClear ? [UIColor whiteColor] :self.backgroundColor;
        self.contentView.backgroundColor = [UIColor colorWithHue:0 saturation:0 brightness:0 alpha:0.4];
    }
